...
let getEquipmentListInShop = function () {
    return new Promise(function (resolve, reject) {
        let result = [];
        for(let key in EquipmentConfig){
            let temp = EquipmentConfig[key];
            temp.key = key;
            result.push(temp);
        }
        resolve(result);
...
let queryStrengthenConfig = function(){
    return new Promise(function (resolve, reject) {
        let result = [];
        for(let key in StrenthenConfig){
            let temp = StrenthenConfig[key];
            temp.level = key;
            result.push(temp);
        }
        resolve(result);
...
exports.queryStrengthenConfig = queryStrengthenConfig;